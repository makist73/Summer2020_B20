...
public class ArrayList_Methods {
    ...
    public static void main(String[] args) {
        ...
        cars.addAll(Arrays.asList("BMW","Mercedes","Honda","Tesla","VW","Lexus","Nissan","Tesla","Mazda"));
        //                          0        1        2        3      4     5      6        7
         //  cars.remove(3);
        //  cars.remove("Tesla"); removes first one
        ...
        groceryList.addAll(Arrays.asList("Eggs","Milk","Toilet Paper", "Paper Towels","Mango","Orange","Dragon Fruit"));
